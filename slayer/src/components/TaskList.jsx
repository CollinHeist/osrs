...
import { MetricDistributionPopup } from "./MetricDistributionPopup.jsx";
 ...
 * }} props
 */
export function TaskList({ tasks, selectedId, onSelect, onEdit, onDelete, search = "" }) {
  ...
  return (
    <div className="task-list">
      ...
      {grouped.length === 0 ? (
        <div className="task-list-empty">
          <p>No monsters match <strong>&ldquo;{search}&rdquo;</strong>.</p>
        </div>
      ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="task-row-metrics">
                      ...
                      <div
                        className="task-row-metric task-row-metric--hoverable"
                        onMouseEnter={(e) =>
                          setMetricHover({
                            taskId: task.id,
                            metric: "xp",
      ...
      {metricHover && (
        <MetricDistributionPopup
          allTasks={tasks}
          focusTaskId={metricHover.taskId}
          metric={metricHover.metric}
          anchorRect={metricHover.rect}
        />
      )}
    </div>
  );
